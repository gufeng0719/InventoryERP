<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory.Master" AutoEventWireup="true" CodeBehind="ManagerList.aspx.cs" Inherits="Inventory.UI.ManagerList" %>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <h4 class="example-title">仓管列表</h4>
                    <div class="example">
                        <table  class="table table-striped">
                            <thead class="thead-dark">
                                <tr>
                                    <th scope="col" >仓管编号</th>
                                    <th  scope="col" >仓管名称</th>
                                    <th scope="col" >性别</th>
                                    <th scope="col" >生日</th>
                                    <th scope="col" >管理库位</th>
                                    <th scope="col">操作</th>
                                </tr>
                            </thead>
                            <tbody>
